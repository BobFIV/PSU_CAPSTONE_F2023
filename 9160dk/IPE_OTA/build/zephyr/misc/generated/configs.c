...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_BLE_GW_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_BLE_GW_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_SIZE, 275);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DRV_RX_STACK_SIZE, 2200);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_2_NRF_HW_ASYNC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_2_NRF_HW_ASYNC_TIMER, 2);
