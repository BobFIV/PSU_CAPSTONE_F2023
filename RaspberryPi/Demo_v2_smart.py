...
#Written by Chang Li 
#Feedback from Yuh:
#You can probably replace detect_color with a simple max statement rather than comparing things by putting them in ranges and then comparing each value individually.
#Its difficult to read and debug. 
